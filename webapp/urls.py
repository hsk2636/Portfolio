...
urlpatterns = (
    [
        ...
        path('api/admin/today-uploaded-count/', views.today_uploaded_count, name='today_uploaded_count'),
        ...
        path('profile-update/', views.profile_update, name='profile_update'),  # 추가된 URL
